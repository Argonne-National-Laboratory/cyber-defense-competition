...
class BasicXDAServer(XDAServer):
	...
	cimore_address = paths['cimore']
	xda_cimore = XDAClient(OPCServerAddress=cimore_address)
		...
		if(i_name == "flow" or i_name == "load"):
			resp = (xda_cimore.Read(ItemContainer(ItemName = self.OPCItemDict[key].ItemName )))
